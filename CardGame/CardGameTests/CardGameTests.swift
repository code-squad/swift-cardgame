...
class CardGameTests: XCTestCase {
    ...
    func testDescriptionForSpades() {
        ...
        XCTAssertEqual(spadesAce.description, "♠A")
        XCTAssertEqual(spadesTwo.description, "♠2")
        XCTAssertEqual(spadesThree.description, "♠3")
        XCTAssertEqual(spadesFour.description, "♠4")
        XCTAssertEqual(spadesFive.description, "♠5")
        XCTAssertEqual(spadesSix.description, "♠6")
        XCTAssertEqual(spadesSeven.description, "♠7")
        XCTAssertEqual(spadesEight.description, "♠8")
        XCTAssertEqual(spadesNine.description, "♠9")
        XCTAssertEqual(spadesTen.description, "♠10")
        XCTAssertEqual(spadesJack.description, "♠J")
        XCTAssertEqual(spadesQueen.description, "♠Q")
        XCTAssertEqual(spadesKing.description, "♠K")
    }
    ...
    func testDescriptionForHearts() {
        ...
        XCTAssertEqual(heartsAce.description, "♥A")
        XCTAssertEqual(heartsTwo.description, "♥2")
        XCTAssertEqual(heartsThree.description, "♥3")
        XCTAssertEqual(heartsFour.description, "♥4")
        XCTAssertEqual(heartsFive.description, "♥5")
        XCTAssertEqual(heartsSix.description, "♥6")
        XCTAssertEqual(heartsSeven.description, "♥7")
        XCTAssertEqual(heartsEight.description, "♥8")
        XCTAssertEqual(heartsNine.description, "♥9")
        XCTAssertEqual(heartsTen.description, "♥10")
        XCTAssertEqual(heartsJack.description, "♥J")
        XCTAssertEqual(heartsQueen.description, "♥Q")
        XCTAssertEqual(heartsKing.description, "♥K")
    }
    ...
    func testDescriptionForDiamonds() {
        ...
        XCTAssertEqual(diamondsAce.description, "♦A")
        XCTAssertEqual(diamondsTwo.description, "♦2")
        XCTAssertEqual(diamondsThree.description, "♦3")
        XCTAssertEqual(diamondsFour.description, "♦4")
        XCTAssertEqual(diamondsFive.description, "♦5")
        XCTAssertEqual(diamondsSix.description, "♦6")
        XCTAssertEqual(diamondsSeven.description, "♦7")
        XCTAssertEqual(diamondsEight.description, "♦8")
        XCTAssertEqual(diamondsNine.description, "♦9")
        XCTAssertEqual(diamondsTen.description, "♦10")
        XCTAssertEqual(diamondsJack.description, "♦J")
        XCTAssertEqual(diamondsQueen.description, "♦Q")
        XCTAssertEqual(diamondsKing.description, "♦K")
    }
    ...
    func testDescriptionForClubs() {
        ...
        XCTAssertEqual(clubsAce.description, "♣A")
        XCTAssertEqual(clubsTwo.description, "♣2")
        XCTAssertEqual(clubsThree.description, "♣3")
        XCTAssertEqual(clubsFour.description, "♣4")
        XCTAssertEqual(clubsFive.description, "♣5")
        XCTAssertEqual(clubsSix.description, "♣6")
        XCTAssertEqual(clubsSeven.description, "♣7")
        XCTAssertEqual(clubsEight.description, "♣8")
        XCTAssertEqual(clubsNine.description, "♣9")
        XCTAssertEqual(clubsTen.description, "♣10")
        XCTAssertEqual(clubsJack.description, "♣J")
        XCTAssertEqual(clubsQueen.description, "♣Q")
        XCTAssertEqual(clubsKing.description, "♣K")
    }
